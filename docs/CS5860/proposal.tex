...
%Example outputs of their architecture given the condition image and a new pose
%are shown more clearly in Figure \ref{fig:pg2_results}.
%
%\begin{figure}[htbp]
...
\begin{tabular}{| m{0.15\textwidth} m{0.05\textwidth} m{0.2\textwidth}|} 
\hline
