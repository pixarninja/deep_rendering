...
\usepackage{amsmath,amsfonts,amssymb,amsthm,array,hyperref,cite,mathtools,mdframed,pgffor,color,xcolor,blindtext}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[L]{{\it Dynamic Frame Generation, Spring 2019}}
\fancyhead[R]{{\it CS5790: Wearable Computing and Complex Systems}}
\raggedcolumns
