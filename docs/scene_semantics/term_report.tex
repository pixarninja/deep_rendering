...
%that could help in generating useful scene semantics.
...
%To demonstrate this, consider an object that is
%straddling a frameblock section.
...
\node[below = 3.75mm of {(-1.5,0)}] {\scriptsize{$\textbf{0x10}$}};
\node[below = 0.5mm of {(-0.5,0)}] {\scriptsize{$g(6)$}};
\node[below = 3.75mm of {(-0.5,0)}] {\scriptsize{$\textbf{0x20}$}};
\node[below = 0.5mm of {(0.5,0)}] {\scriptsize{$g(7)$}};
\node[below = 3.75mm of {(0.5,0)}] {\scriptsize{$\textbf{0x40}$}};
\node[below = 0.5mm of {(1.5,0)}] {\scriptsize{$g(8)$}};
\node[below = 3.75mm of {(1.5,0)}] {\scriptsize{$\textbf{0x80}$}};
% Labels
\node[left = -3mm of {(-1.5,1.5)},fill=white] {$16$};
\node[left = -3mm of {(-0.5,1.5)},fill=white] {$32$};
\node[left = -3mm of {(0.5,1.5)},fill=white] {$48$};
\node[left = -3mm of {(1.5,1.5)},fill=white] {$64$};
\node[left = -3mm of {(-1.5,0.5)},fill=white] {$80$};
\node[left = -3mm of {(-0.5,0.5)},fill=white] {$96$};
\node[left = -3.675mm of {(0.5,0.5)},fill=white] {$112$};
\node[left = -3.75mm of {(1.5,0.5)},fill=white] {$128$};
\end{tikzpicture}
\caption{Final partition of screen space, where $g$ is overlaid on top of the $r$ and $b$ parameterization.}
\label{fig:partition}
\end{minipage}
\end{center}
\end{figure}
...
This proves that, although there are less frameblocks than the 512 case,
the accuracy of the colors increases for objects spanning frameblock sections.
...
\begin{tikzpicture}
% G
\draw (-3,1.9) -- (0,1.9); % g horizontal line
\draw (-3,1.85) -- (-3,1.95); % g left tick
\draw (0,1.85) -- (0,1.95); % g right tick
\node[above = 0.5mm of {(-1.5,1.9)}] {$g(6)$};
\draw (0,1.9) -- (3,1.9); % g horizontal line
\draw (0,1.85) -- (0,1.95); % g left tick
\draw (3,1.85) -- (3,1.95); % g right tick
\node[above = 0.5mm of {(1.5,1.9)}] {$g(7)$};
...
% R
%\draw (-3,-1.9) -- (0,-1.9); % r horizontal line
%\draw (-3,-1.85) -- (-3,-1.95); % r left tick
%\draw (0,-1.85) -- (0,-1.95); % r right tick
\node[below = 0mm of {(-2.25,-1.75)}] {$r_1(3)$};
\node[below = 0mm of {(-0.75,-1.75)}] {$r_1(4)$};
%\draw (0,-1.9) -- (3,-1.9); % r horizontal line
%\draw (0,-1.85) -- (0,-1.95); % r left tick
%\draw (3,-1.85) -- (3,-1.95); % r right tick
\node[below = 0mm of {(0.75,-1.75)}] {$r_1(5)$};
\node[below = 0mm of {(2.25,-1.75)}] {$r_1(6)$};
% B
%\draw (-3.4,-1.5) -- (-3.4,1.5); % b vertical line
%\draw (-3.35,1.5) -- (-3.45,1.5); % b top tick
%\draw (-3.35,-1.5) -- (-3.45,-1.5); % b bottom tick
\node[left = 0mm of {(-3.2,0.75)}] {$b_1(3)$};
\node[left = 0mm of {(-3.2,-0.75)}] {$b_1(4)$};
% Left pairs
\filldraw[draw=black,fill={0,4,2}] (-3,-1.5) rectangle (-1.5,0); % bottom left
\filldraw[draw=black,fill={0,4,4}] (-1.5,-1.5) rectangle (0,0); % bottom right
\filldraw[draw=black,fill={2,4,0}] (-3,0) rectangle (-1.5,1.5); % top left
\filldraw[draw=black,fill={4,4,0}] (-1.5,0) rectangle (0,1.5); % top right
% Right pairs
\filldraw[draw=black,fill={0,6,2}] (0,-1.5) rectangle (1.5,0); % bottom left
\filldraw[draw=black,fill={0,6,4}] (1.5,-1.5) rectangle (3,0); % bottom right
\filldraw[draw=black,fill={2,6,0}] (0,0) rectangle (1.5,1.5); % top left
\filldraw[draw=black,fill={4,6,0}] (1.5,0) rectangle (3,1.5); % top right
% Object
...
While the 8-bit model is useful for integer storage of color values,
higher precision models can be applied to shrink frameblock resolution even further.
Using floating-point values, we can have up to 64 bits of precision.
While this is great in theory, the increased precision makes it harder to distinguish
objects from each other at rendertime, and requires many more bits to store the encodings.
...
\coordinate (Q) at (3,0);
\coordinate (R) at (2,-1.25);
\draw (-1.25,0.5) -- (-0.75,0.5); % Screen (top)
\draw (-1,-0.5) -- (-1,0.5); % Screen (Z)
\draw (-1.25,-0.5) -- (-0.75,-0.5); % Screen (bottom)
\draw (-1,0) -- (1.5,1.5); % ZP
\draw (-1,0) -- (3,0); % ZQ
\draw (-1,0) -- (2,-1.25); % ZR
\draw[dashed] (1.5,1.5) -- (2,-1.25); % PR
\draw[dashed] (1.5,1.5) -- (3,0); % PQ
\draw[dashed] (3,0) -- (2,-1.25); % QR
%%Labels for the vertices are typeset.
\node[below left = -2.45mm of {(1.5,1.5)}] {\textbullet}; % P
\node[below left = -2.35mm of {(3,0)}] {\textbullet}; % Q
\node[below left = -2.5mm of {(2,-1.25)}] {\textbullet}; % R
\node[right = 1mm of {(1.5,1.65)}] {$P : \{d_P,t_P,r_P,s_P\}$};
\node[right = 1mm of {(3,0)}] {$Q : \{d_Q,t_Q,r_Q,s_Q\}$};
\node[right = 1mm of {(2,-1.25)}] {$R : \{d_R,t_R,r_R,s_R\}$};
\node[right = -5mm of {(-1,-0.85)}] {$S_{x,y,z}$};
\end{tikzpicture}
\end{center}
